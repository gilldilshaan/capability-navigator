      ...
      <div className="grid gap-4 xl:grid-cols-4">
        ...
        <Panel className="p-4 xl:col-span-2">
          ...
          <p className="mt-1.5 text-xs text-foreground/85">
            Identify lost capability → decompose it → discover available resources → generate
            alternative configurations → simulate → evaluate cost, time, risk, compliance →
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Panel className="flex flex-col p-4">
              ...
              <p className="mt-1.5 text-xs text-muted-foreground">
                Decompose CAP-THS-017 into its seven required sub-capabilities and see which ones
                survived.
              </p>
              <Link
                to="/capability-map"
