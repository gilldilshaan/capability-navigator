 ...
 *
 * TEMPORARY MOCK SOURCE: every array below doubles as the mock/fallback
 * response for the API service layer (src/services/*) until the backend
 * modules are available. Types live canonically in src/types/parallax.ts.
 */
...
export const machines: Machine[] = [
  {
    id: "CNC-17",
    name: "CNC-17 Precision Former",
    factoryId: "FAC-02",
    status: "IDLE",
    utilisationPct: 8,
    capability: "CAP-PRF-008",
    toleranceMicron: 12,
  },
  {
    id: "FORM-08",
    name: "FORM-08 Thermoformer",
    factoryId: "FAC-02",
    status: "AVAILABLE",
    utilisationPct: 34,
    capability: "CAP-THS-017",
    toleranceMicron: 25,
  },
  {
    id: "CNC-09",
    name: "CNC-09 Precision Former",
    factoryId: "FAC-04",
    status: "AVAILABLE",
    utilisationPct: 51,
    capability: "CAP-PRF-008",
  ...
  {
    id: "SEAL-04",
    name: "SEAL-04 Cold Seal Unit",
    factoryId: "FAC-02",
    status: "AVAILABLE",
    utilisationPct: 44,
    capability: "CAP-CCH-003",
    toleranceMicron: 40,
  },
  {
    id: "SEAL-06",
    name: "SEAL-06 Cold Seal Unit",
    factoryId: "FAC-06",
    status: "AVAILABLE",
    utilisationPct: 22,
    capability: "CAP-CCH-003",
  ...
  {
    id: "QC-SCAN-03",
    name: "QC-SCAN-03 Vision Inspector",
    factoryId: "FAC-02",
    status: "AVAILABLE",
    utilisationPct: 39,
    capability: "CAP-QCF-002",
    toleranceMicron: 5,
  },
  {
    id: "QC-SCAN-05",
    name: "QC-SCAN-05 Vision Inspector",
    factoryId: "FAC-01",
    status: "PARTIAL",
    utilisationPct: 88,
    capability: "CAP-QCF-002",
  ...
  {
    id: "EXT-02",
    name: "EXT-02 Resin Extruder",
    factoryId: "FAC-03",
    status: "AVAILABLE",
    utilisationPct: 46,
    capability: "CAP-POL-001",
    toleranceMicron: 60,
  },
  {
    id: "EXT-05",
    name: "EXT-05 Resin Extruder",
    factoryId: "FAC-05",
    status: "AT RISK",
    utilisationPct: 63,
    capability: "CAP-POL-001",
  ...
  {
    id: "LAM-07",
    name: "LAM-07 Film Laminator",
    factoryId: "FAC-05",
    status: "AVAILABLE",
    utilisationPct: 30,
    capability: "CAP-CFM-009",
    toleranceMicron: 22,
  },
  {
    id: "AUT-12",
    name: "AUT-12 Autoclave",
    factoryId: "FAC-04",
    status: "AVAILABLE",
    utilisationPct: 55,
    capability: "CAP-QCF-002",
...
export const inventory: InventoryItem[] = [
  {
    id: "INV-3301",
    name: "ThermoShield Resin",
    units: 1840,
    uom: "kg",
    location: "Plant 02 / WH-A",
    status: "AVAILABLE",
    coversDays: 9,
  },
  {
    id: "INV-3302",
    name: "Packaging Film (480 mm)",
    units: 5200,
    uom: "rolls",
    location: "Plant 02 / WH-B",
    status: "AVAILABLE",
    coversDays: 21,
  },
  {
    id: "INV-3303",
    name: "ThermoShield Module (FG)",
    units: 410,
    uom: "units",
    location: "Plant 04 / FG",
    status: "PARTIAL",
    coversDays: 2,
  },
  {
    id: "INV-3304",
    name: "Cold Seal Adhesive",
    units: 780,
    uom: "kg",
    location: "Plant 02 / WH-A",
    status: "AVAILABLE",
  ...
  {
    id: "INV-3305",
    name: "Phase-Change Gel Packs",
    units: 12400,
    uom: "units",
    location: "Cryolink DEL Hub",
    status: "AVAILABLE",
    coversDays: 18,
  },
  {
    id: "INV-3306",
    name: "Precision Forming Tooling Set",
    units: 3,
    uom: "sets",
    location: "Plant 02 / Tool Crib",
    status: "AVAILABLE",
    coversDays: 120,
  },
  {
    id: "INV-3307",
    name: "Barrier Laminate Sheet",
    units: 2600,
    uom: "sheets",
    location: "Plant 05 / WH-C",
    status: "AT RISK",
    coversDays: 6,
  },
  {
    id: "INV-3308",
    name: "Sterile Liner Inserts",
    units: 9100,
    uom: "units",
    location: "Plant 01 / WH-A",
    status: "AVAILABLE",
    coversDays: 26,
  },
  {
    id: "INV-3309",
    name: "QC Reference Standards",
    units: 46,
    uom: "kits",
    location: "Plant 02 / QC Lab",
    status: "AVAILABLE",
    coversDays: 90,
  },
  {
    id: "INV-3310",
    name: "Secondary Carton Stock",
    units: 18500,
    uom: "units",
    location: "Plant 06 / WH-A",
    status: "AVAILABLE",
    coversDays: 33,
  },
];
...
export const workforce: WorkforceRecord[] = [
  {
    id: "EMP-1842",
    role: "Machine Operator II",
    site: "Plant 02",
    compatibility: 87,
    machineOperation: 92,
    qualityInspection: 81,
    precisionForming: 76,
    coldChain: 68,
    trainingHours: 12,
    recommendation: "Deploy after targeted training.",
  },
  {
    id: "EMP-2197",
  ...
  },
  {
    ...
    compatibility: 74,
    machineOperation: 61,
    qualityInspection: 94,
    precisionForming: 58,
    coldChain: 71,
    trainingHours: 24,
    recommendation: "Pair with senior former operator.",
  },
  {
    id: "EMP-1766",
  ...
  {
    id: "EMP-3120",
    role: "Cold-Chain Handler",
    site: "Cryolink DEL",
    compatibility: 66,
    machineOperation: 52,
    qualityInspection: 63,
    precisionForming: 38,
    coldChain: 95,
    trainingHours: 36,
    recommendation: "Assign to cold-chain leg only.",
  },
  {
    id: "EMP-2588",
    role: "Machine Operator I",
    site: "Plant 06",
    compatibility: 71,
    machineOperation: 80,
    qualityInspection: 62,
    precisionForming: 64,
    coldChain: 55,
    trainingHours: 22,
    recommendation: "Shortlist — secondary wave.",
  },
  {
    id: "EMP-1903",
    ...
    compatibility: 81,
    machineOperation: 70,
    qualityInspection: 86,
    precisionForming: 84,
    coldChain: 60,
    trainingHours: 10,
    recommendation: "Deploy as shift capability lead.",
  },
  {
    id: "EMP-2731",
  ...
  },
  {
    ...
    coldChain: 40,
    trainingHours: 32,
    recommendation: "Support role only.",
  },
  {
    id: "EMP-1655",
  ...
  },
  {
    ...
    compatibility: 52,
    machineOperation: 34,
    qualityInspection: 88,
    precisionForming: 29,
    coldChain: 44,
    trainingHours: 48,
    recommendation: "Not viable for line deployment.",
  },
  {
    id: "EMP-2860",
    role: "Machine Operator II",
  ...
  {
    id: "EMP-1998",
    role: "Forming Specialist",
    site: "Plant 04",
    compatibility: 85,
    machineOperation: 86,
    qualityInspection: 72,
    precisionForming: 91,
    coldChain: 49,
    trainingHours: 11,
    recommendation: "Deploy after targeted training.",
  },
  {
    ...
    compatibility: 58,
    machineOperation: 44,
    qualityInspection: 57,
    precisionForming: 33,
    coldChain: 83,
    trainingHours: 40,
    recommendation: "Assign to route orchestration.",
  },
  {
    id: "EMP-3055",
...
export const logisticsRoutes: LogisticsRoute[] = [
  {
    ...
    transitHours: 7,
    coldChain: true,
    constraints: "Night-run restriction on 3 segments.",
  },
  {
    id: "RTE-BOM-CHD",
    from: "BOM",
    ...
    transitHours: 34,
    coldChain: true,
    constraints: "Corridor congestion; 2 of 3 carriers committed.",
  },
  {
    id: "RTE-PNQ-CHD",
    from: "PNQ",
    ...
    transitHours: 19,
    coldChain: true,
    constraints: "Air leg capacity 400 kg/day.",
  },
  {
    id: "RTE-CHD-BDI",
    from: "CHD",
  ...
  },
  {
    ...
    transitHours: 41,
    coldChain: true,
    constraints: "Reefer wagon availability 2 days/week.",
  },
  {
    id: "RTE-AMD-CHD",
    from: "AMD",
  ...
  },
  {
    ...
    transitHours: 26,
    coldChain: true,
    constraints: "Cost premium 2.1x baseline.",
  },
  {
    id: "RTE-CHD-DEL",
    from: "CHD",
    ...
    transitHours: 6,
    coldChain: false,
    constraints: "Ambient only — not FG qualified.",
  },
];
...
export const capabilities: Capability[] = [
  ...
  {
    id: "CAP-POL-001",
    name: "Polymer Material Supply",
    requirements: [],
    redundancy: 4,
    targetRedundancy: 3,
    status: "AVAILABLE",
    owner: "Direct Materials",
  },
  {
    id: "CAP-QCF-002",
    name: "Quality Certification",
    requirements: ["CAP-PPC-004"],
    redundancy: 3,
    targetRedundancy: 3,
    status: "AVAILABLE",
...
export const activeDisruption: Disruption = {
  id: "INC-2048",
...
export const recoveryPaths: RecoveryPath[] = [
  {
    ...
    rationale:
      "Restores full volume but concentrates the outcome on one new tier-1 dependency and a 14-day qualification window.",
    factors: [
      {
        key: "speed",
        ...
        weight: 30,
        score: 34,
        note: "14 days vs 72-hour impact horizon",
      },
      {
        key: "risk",
        label: "Risk",
        weight: 25,
        score: 58,
        note: "Unproven supplier, audit pending",
      },
      ...
      },
      {
        ...
        weight: 10,
        score: 30,
        note: "1 node carries the whole outcome",
      },
    ],
  },
  {
    ...
    rationale:
      "Halves recovery time using internal capacity, but Plant 04 is 41% free and shares a changeover window with the parenteral line.",
    factors: [
      {
        key: "speed",
        label: "Recovery speed",
        weight: 30,
        score: 62,
        note: "7 days to first qualified output",
      },
      { key: "risk", label: "Risk", weight: 25, score: 72, note: "Known plant, contended line" },
      {
        ...
        weight: 20,
        score: 66,
        note: "₹9.2L — internal transfer pricing",
      },
      {
        key: "capacity",
        label: "Capacity coverage",
  ...
  },
  {
    ...
    rationale:
      "Highest recovery speed with lowest dependency concentration. Reconstructs the outcome from assets already inside the network.",
    factors: [
      {
        key: "speed",
        label: "Recovery speed",
        weight: 30,
        score: 96,
        note: "3.2 days — inside the 72-hour horizon",
      },
      {
        key: "risk",
        label: "Risk",
        weight: 25,
        score: 91,
        note: "All resources already qualified",
      },
      {
        key: "cost",
        label: "Cost",
        weight: 20,
        score: 94,
        note: "₹3.4L — mostly internal reallocation",
      },
      {
        key: "capacity",
        label: "Capacity coverage",
      ...
      },
      {
        ...
        weight: 10,
        score: 96,
        note: "No single node above 22% of the outcome",
      },
    ],
  },
];
...
export const thermoShieldDecomposition: DecompNode[] = [
  {
    ...
    status: "AVAILABLE",
    dependencies: 4,
    provider: "NorthStar / Aegis / Helix",
  },
  {
    id: "CAP-TRS-006",
    ...
    status: "AVAILABLE",
    dependencies: 2,
    provider: "Materials R&D spec MS-441",
  },
  {
    id: "CAP-PRF-008",
  ...
  },
  {
    ...
    status: "AVAILABLE",
    dependencies: 2,
    provider: "QC-SCAN-03, Orbit Labs",
  },
  {
    id: "CAP-CCH-003",
    ...
    status: "AVAILABLE",
    dependencies: 2,
    provider: "Cryolink, SEAL-04",
  },
  {
    id: "CAP-WPK-007",
    label: "Packaging Workforce",
    status: "PARTIAL",
    dependencies: 1,
    provider: "12 transferable records",
  },
  {
    id: "CAP-RLG-005",
    ...
    status: "AT RISK",
    dependencies: 2,
    provider: "RTE-DEL-CHD / RTE-BOM-CHD",
  },
];
...
export const failureToggles: FailureToggle[] = [
  {
    id: "supplier",
    label: "Remove critical supplier",
    detail: "MedCore Components Ltd. (SUP-1001)",
    resilienceHit: 14,
    removes: ["SUP-1001"],
  },
  {
    id: "factory",
    label: "Disable factory",
    detail: "Plant 02 (FAC-02)",
    resilienceHit: 11,
    removes: ["FAC-02"],
  },
  {
    id: "machine",
    label: "Disable machine",
    detail: "CNC-17 precision former",
    resilienceHit: 6,
    removes: ["CNC-17"],
  },
  {
    id: "route",
    label: "Block logistics route",
    detail: "RTE-DEL-CHD cold corridor",
    resilienceHit: 9,
    removes: ["RTE-DEL-CHD"],
  },
  {
    id: "workforce",
    label: "Remove specialized workforce",
    detail: "Precision packaging skill pool",
    resilienceHit: 8,
    removes: ["WF-PRF"],
  },
  {
    id: "cert",
    label: "Multiple simultaneous failures",
    detail: "Certification lab + BOM corridor + Plant 05",
    resilienceHit: 19,
    removes: ["SUP-1010", "RTE-BOM-CHD", "FAC-05"],
  },
];
...
export const sapLayers = [
  {
    id: "S/4HANA",
    name: "SAP S/4HANA",
    role: "Enterprise operational data",
    detail: "Materials, plants, orders, supplier master.",
  },
  {
    id: "HANA",
    name: "SAP HANA Cloud",
    role: "Capability / dependency intelligence",
    detail: "Graph store for the capability network.",
  },
  {
    id: "BTP",
    name: "SAP BTP",
    role: "Agent orchestration",
    detail: "Sensing, capability, resource, reconstruction, scenario agents.",
  },
  {
    id: "GENAI",
    name: "SAP Generative AI Hub",
    role: "AI reasoning",
    detail: "Configuration generation and rationale synthesis.",
  },
  {
    id: "BUILD",
    name: "SAP Build",
    role: "User interface",
    detail: "Resilience command center and approval workflow.",
  },
];
...
export const graphNodes: GraphNode[] = [
  ...
  },
  {
    ...
    status: "PARTIAL",
    risk: "MEDIUM",
    meta: "12 transferable",
  },
  {
    id: "CAP-THS-017",
    label: "ThermoShield Capability",
    kind: "capability",
    x: 860,
    y: 240,
    status: "AT RISK",
