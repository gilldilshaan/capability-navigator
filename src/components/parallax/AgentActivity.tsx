      ...
      {agentPanelOpen ? (
        <>
            ...
            {agents.map((agent, i) => (
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="truncate text-xs font-medium text-foreground uppercase">
                    {agent.code}
                  </span>
          ...
          <div className="min-h-0 flex-1 border-t border-border">
            ...
            <div
              ref={logRef}
              className="h-full max-h-[calc(100vh-34rem)] min-h-32 overflow-y-auto px-4 pb-6"
            >
              {activity.map((entry) => (
